...
#'
#'     This data check answers: "Is country known?" question.\cr Data check will pass if \strong{Country name (dwc:country) is in vocabulary} and will fail if \strong{Country name (dwc:country) not in vocabulary}.\cr Dimension of this data check is \strong{Conformance} and it's flagging type is: \strong{FLAG}\cr Example of entries that will pass: \code{AUS,JP}, such data check will return \code{TRUE}.\cr Example of entries that will fail: \code{xxx, AUST, 1}, such data check will return \code{FALSE}.
