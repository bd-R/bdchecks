#' @rdname dc_validation_maxelevation_outofrange
#' 
#' @param TARGET a vector of maximum elevation meters. To pass it must
...
#' 
dc_validation_maxelevation_outofrange <- function(
  TARGET = NULL,
  lower_limit = -428,
  upper_limit = 8850
) {
