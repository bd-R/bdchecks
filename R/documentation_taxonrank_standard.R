...
#' 
#'
#'     This data check answers: "Is taxonRank information standard?"
#' question.\cr Data check will pass if \strong{The value for taxonRank is
#' standard.} and will fail if \strong{The value for taxonRank is missing or
#' not standard.}.\cr Dimension of this data check is \strong{} and it's
