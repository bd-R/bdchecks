#'
#' Data check validation_taxon_empty Check if at least one field needed to determine the taxon of the entity exists and is not empty.
#'
...
#' @name dc_validation_taxon_empty
