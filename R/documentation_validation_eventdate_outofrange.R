#'
#' Data check validation_eventdate_outofrange Check if eventDate is not empty and is within given earliest and latest dates.
#'
...
#' @name dc_validation_eventdate_outofrange
#' @format An object of class function to perform a specific data check.
#' @references None
#' @examples 
#' perform_dc(data_bats, 'validation_eventdate_outofrange')
