#'
#' Data check decimallongitude_inrange Check if decimalLongitude is within
#' parameter range.
#'
#'     This data check answers: "Is decimalLongitude within parameter range?"
...
#' decimalLongitude is not within given numbers.}.\cr Dimension of this data
...
#' @references None
#' @examples 
#' perform_dc(data_bats, 'decimallongitude_inrange')
